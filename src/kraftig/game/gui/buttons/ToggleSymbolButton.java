...
public class ToggleSymbolButton extends ToggleButton
{
    private final Runnable symbol;
    
    public ToggleSymbolButton(Vec2 radius, Runnable symbol)
    {
        super(radius);
    ...
    public ToggleSymbolButton(Vec2 radius, Runnable symbol, Vec2 pos, Alignment align)
    {
        this(radius, symbol);
        setPos(pos, align);
    }
